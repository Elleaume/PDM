...
with open('configs/seg_unet_CIMAS.json') as config_file:
...
n_vol_trains = [1]
seeds = [50]  #0, 10, 20, 30, 40, 
options = ['option_7_3','option_8_3' ]#, 'option_2', 'option_3', 'option_4', 'option_5', 'option_6', 'option_7'] 
            ...
            for option in options :
                ...
                # CIMAS pretraining
                    ...
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_d/" + \
                                            "CIMAS_3volumesPerBatch/"
                    pretraining = 'pretrained with CIMAS (global_d)' 
                elif option == 'option_2':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_dminus/" + \
                                            "CIMAS_3volumesPerBatch/"
                    pretraining = 'pretrained with CIMAS (global_dminus)'
                    
                # ACDC pretraining
                elif option == 'option_3':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_dminus/" + \
                                            "ACDC_12volumesPerBatch/"
                    pretraining = 'pretrained with ACDC (global_dminus)' 
                elif option == 'option_4':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_d/" + \
                                            "ACDC_12volumesPerBatch/"
                    pretraining = 'pretrained with ACDC (global_d)' 
                    
                # MMWHS pretraining
                elif option == 'option_5':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_d/" + \
                                            "MMWHS_3volumesPerBatch/"
                    pretraining = 'pretrained with MMWHS (global_d)' 
                elif option == 'option_6':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_dminus/" + \
                                            "MMWHS_3volumesPerBatch/"
                    pretraining = 'pretrained with MMWHS (global_dminus)'
                    
                    
                    
                # MMWHS and ACDC pretraining
                elif option == 'option_7':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_d/" + \
                                            "MMWHS_ACDC_6volumesPerBatch/"
                    pretraining = 'pretrained with MMWHS-ACDC (global_d)' 
                ...
                # ACDC and CIMAS pretraining
                elif option == 'option_7_2':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_d/" + \
                                            "ACDC_CIMAS_6volumesPerBatch/"
                    pretraining = 'pretrained with ACDC-CIMAS (global_d)' 
                elif option == 'option_8_2':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_dminus/" + \
                                            "ACDC_CIMAS_6volumesPerBatch/"
                    pretraining = 'pretrained with ACDC-CIMAS (global_dminus)' 
                    
                # CIMAS and MMWHS pretraining
                elif option == 'option_7_3':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_d/" + \
                                            "CIMAS_MMWHS_5volumesPerBatch/"
                    pretraining = 'pretrained with CIMAS-MMWHS (global_d)' 
                elif option == 'option_8_3':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_dminus/" + \
                                            "CIMAS_MMWHS_5volumesPerBatch/"
                    pretraining = 'pretrained with CIMAS-MMWHS (global_dminus)' 
                    
                # MMWHS ACDC and CIMAS pretraining
                elif option == 'option_9':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_d/" + \
                                            "MMWHS_ACDC_CIMAS_4volumesPerBatch/"
                    pretraining = 'pretrained with MMWHS-ACDC-CIMAS (global_d)' 
                elif option == 'option_10':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_dminus/" + \
                                            "MMWHS_ACDC_CIMAS_4volumesPerBatch/"
                    pretraining = 'pretrained with MMWHS-ACDC-CIMAS (global_dminus)' 
                ...
                # 4 datasets in pretraining
                    ...
                    pretraining = 'pretrained with ACDC-HCP-Chaos-MedDecath Prostate (global_dminus)' 
                elif option == 'option_12':
                    save_models_pretrain = save_global_path + "pretrainings" + \
                                            "/global_d/" + \
                                            "ACDC_HCP_Chaos_Medical Decathelon Prostate_3volumesPerBatch/"
                    pretraining = 'pretrained with ACDC-HCP-Chaos-MedDecath Prostate (global_d)'
                    
                # 4 datasets in pretraining
                elif option == 'option_13':
                    save_models_pretrain = save_global_path + "pretrainings" + \
                                            "/global_dminus/" + \
                                            "MMWHS_HCP_Chaos_Medical Decathelon Prostate_3volumesPerBatch/"
                    pretraining = 'pretrained with MMWHS-HCP-Chaos-MedDecath Prostate (global_dminus)' 
                elif option == 'option_14':
                    save_models_pretrain = save_global_path + "pretrainings" + \
                                            "/global_d/" + \
                                            "MMWHS_HCP_Chaos_Medical Decathelon Prostate_3volumesPerBatch/"
                    pretraining = 'pretrained with MMWHS-HCP-Chaos-MedDecath Prostate (global_d)'
                    
                # 4 datasets in pretraining
                elif option == 'option_15':
                    save_models_pretrain = save_global_path + "pretrainings" + \
                                            "/global_dminus/" + \
                                            "CIMAS_HCP_Chaos_Medical Decathelon Prostate_3volumesPerBatch/"
                    pretraining = 'pretrained with CIMAS-HCP-Chaos-MedDecath Prostate (global_dminus)' 
                elif option == 'option_16':
                    save_models_pretrain = save_global_path + "pretrainings" + \
                                            "/global_d/" + \
                                            "CIMAS_HCP_Chaos_Medical Decathelon Prostate_3volumesPerBatch/"
                    pretraining = 'pretrained with CIMAS-HCP-Chaos-MedDecath Prostate (global_d)'
