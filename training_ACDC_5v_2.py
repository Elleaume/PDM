        ...
        for n_vol_train in n_vol_trains:
            ...
            for option in options :
                ...
                # HCP and ACDC pretraining
                    ...
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_d/" + \
                                            "HCP_USZ_6volumesPerBatch/"
                    pretraining = 'pretrained with HCP-USZ (global_d)' 
                elif option == 'option_6':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_dminus/" + \
                                            "HCP_USZ_6volumesPerBatch/"
                    pretraining = 'pretrained with HCP-USZ (global_dminus)' 
                    
                # HCP and ACDC pretraining
                elif option == 'option_5_2':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_d/" + \
                                            "Abide_HCP_USZ_4volumesPerBatch/"
                    pretraining = 'pretrained with Abide-HCP-USZ (global_d)' 
                elif option == 'option_6_2':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/global_dminus/" + \
                                            "Abide_HCP_USZ_4volumesPerBatch/"
                    pretraining = 'pretrained with Abide-HCP-USZ (global_dminus)' 
