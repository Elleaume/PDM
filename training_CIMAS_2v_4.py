...
n_vol_trains = [2]
seeds = [3, 20, 23, 38, 41]
options = ['option_4']#, 'option_2', 'option_3', 'option_4', 'option_5', 'option_6', 'option_7'] 
        ...
        for n_vol_train in n_vol_trains:
            ...
            if dataset == 'CIMAS' or dataset == 'Abide' :
                ...
                dataset_loader_validation = initialize_dataset(config_datasets, config_seg, dataset, 
                                                               total_n_volumes=total_n_volumes_val, 
            ...
            for option in options :
                ...
                # ACDC pretraining
                    ...
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/representation_loss_global_d/" + \
                                            "ACDC_12volumesPerBatch/"
                    pretraining = 'pretrained with ACDC (representation_loss_global_d)' 
                elif option == 'option_4':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/representation_loss_global_dminus/" + \
                                            "ACDC_12volumesPerBatch/"
                    pretraining = 'pretrained with ACDC (representation_loss_global_dminus)' 
                ...
                # Abide pretraining 
                    ...
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/representation_loss_global_d/" + \
                                            "Abide_12volumesPerBatch/"
                    pretraining = 'pretrained with Abide (representation_loss_global_d)' 
                elif option == 'option_8':
                    save_models_pretrain = save_global_path +  "pretrainings" + \
                                           "/representation_loss_global_dminus/" + \
                                            "Abide_12volumesPerBatch/"
                    pretraining = 'pretrained with Abide (representation_loss_global_dminus)' 
                ...
                # Fancy global d
                    ...
                    save_models_pretrain = save_global_path + "pretrainings" + \
                                            "/representation_loss_global_d/" + \
                                            "4datasets_3volumesPerBatch/"
                    pretraining = 'pretrained with 4 datasets (representation_loss_global_d)' 
                ...
                # Fancy global_dminus 
                    ...
                    save_models_pretrain = save_global_path + "pretrainings" + \
                                            "/representation_loss_global_dminus/" + \
                                            "4datasets_3volumesPerBatch/"
                    pretraining = 'pretrained with 4 datasets (representation_loss_global_dminus)' 
                elif option == 'option_14':
                    save_models_pretrain = save_global_path + "pretrainings" + \
                                            "/2_steps_global_dminus/" + \
                                            "4datasets_3volumesPerBatch/"
                    pretraining = 'pretrained with 4 datasets (2 steps global_dminus)' 
                    
                # Demeaned global d 
                elif option == 'option_15':
                    save_models_pretrain = save_global_path + "pretrainings" + \
                                            "/demeaned_representation_loss_0/" + \
                                            "4datasets_3volumesPerBatch/"
                    pretraining = 'pretrained with 4 datasets (demeaned_representation_loss)' 
                ...
                if option != 'baseline':
                    ...
                    epoch = 799#losses_pretrained.loc[losses_pretrained['validation loss'] == \
